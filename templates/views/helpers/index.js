...
module.exports = function () {
	...
	// Direct url link to a specific startup
	_helpers.startupUrl = function (startupSlug, options) {
		return ('/startup/' + startupSlug);
	};
...
// Direct url link to a specific post
_helpers.startupUrl = function (slug, options) {
	return ('/startup/' + slug);
};
